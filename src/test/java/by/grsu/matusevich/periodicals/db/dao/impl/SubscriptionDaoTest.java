...
public class SubscriptionDaoTest extends AbstractTest {
	private static final IDao<Integer, PublishingHouse> PublisgingHouseDao = PublishingHouseDaoImpl.INSTANCE;
	private static final IDao<Integer, Periodicals> periodicalsDao = PeriodicalsDaoImpl.INSTANCE;
	private static final IDao<Integer, Subscription> subscriptoinDao = SubscriptionDaoImpl.INSTANCE;
